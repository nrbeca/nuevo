            ...
            with tab2:
                ...
                if not resultados_ur:
                    ...
                    with col_izq:
                        ...
                        # Obtener datos de pasivos de la UR (desde config.py)
                        pasivos_ur = obtener_pasivos_ur(ur_codigo, usar_2026=config['usar_2026'])
                        
                        cp1, cp2 = st.columns(2)
                        with cp1:
                            valor_shcp = format_currency(pasivos_ur['Devengado'])
                        ...
                        with cp2:
                            valor_cop10 = format_currency(pasivos_ur['Pagado'])
                        ...
                        pct_avance_pasivos = pasivos_ur['PctAvance'] * 100
                        ...
                        if devengado > 0:
                            fig3 = go.Figure(go.Pie(
                                ...
                                hole=0.6, 
                                marker_colors=[COLOR_VERDE, COLOR_GRIS], 
                                textinfo='none'
                            ))
                            fig3.add_annotation(
                                text=f"{pct_avance_pasivos:.2f}%", 
                                x=0.5, y=0.5, 
                                font_size=18, 
                                font_color=COLOR_VINO, 
                                showarrow=False
                            )
                        else:
                            fig3 = go.Figure(go.Pie(
