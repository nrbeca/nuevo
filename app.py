...
# ============================================================================
    ...
    with tab1:
        ...
        st.markdown("5/ No se están considerando montos de los Controles Operativos (COP): COP 62 la cantidad de $-- (--) esto en la UR 120; y en COP 67 la cantidad de $-- (--) esto en las UR 512 y 513")
